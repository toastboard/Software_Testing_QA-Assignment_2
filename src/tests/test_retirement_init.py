...
class TestRetirementInit(unittest.TestCase):
    ...
    def test_retirement_age_init(self):
        ...
        with self.assertRaises(ValueError) as context:
            self.retirement_calculator = RetirementCalculator(-500,
                                                              self.control_salary,
        ...
        # expected: ValueError
        with self.assertRaises(ValueError) as context:
            self.retirement_calculator = RetirementCalculator(-1,
                                                              self.control_salary,
                                                              self.control_percent_savings,
                                                              self.control_goal)
        self.assertEqual(str(context.exception),
        ...
        # expected: pass
        self.retirement_calculator = RetirementCalculator(0,
                                                          self.control_salary,
                                                          self.control_percent_savings,
                                                          self.control_goal)
        ...
        # expected: pass
        self.retirement_calculator = RetirementCalculator(self.control_age,
                                                          self.control_salary,
                                                          self.control_percent_savings,
                                                          self.control_goal)
        ...
        # expected: pass
        self.retirement_calculator = RetirementCalculator(99,
                                                          self.control_salary,
                                                          self.control_percent_savings,
                                                          self.control_goal)
        ...
        # expected: ValueError
        with self.assertRaises(ValueError) as context:
            self.retirement_calculator = RetirementCalculator(100,
                                                              self.control_salary,
                                                              self.control_percent_savings,
                                                              self.control_goal)
        self.assertEqual(str(context.exception),
    ...
    def test_retirement_salary(self):
        ...
        # expected: pass
        self.retirement_calculator = RetirementCalculator(self.control_age, 1,
                                                          self.control_percent_savings,
                                                          self.control_goal)
    ...
    def test_diff_types(self):
        ...
        with self.assertRaises(TypeError):
            self.retirement_calculator = RetirementCalculator("test",
                                                              self.control_salary,
                                                              self.control_percent_savings,
                                                              self.control_goal)
    ...
    def test_getters(self):
        ...
        # Case: Age
        # expected: 30
        self.assertEqual(self.control_age,
                         self.retirement_calculator.get_age())

        # Case: Salary
        # expected: 80,000
        self.assertEqual(self.control_salary,
                         self.retirement_calculator.get_salary())

        # Case: Percent Saved per Year
        # expected: 0.12
        self.assertEqual(self.control_percent_savings,
                         self.retirement_calculator.get_percent_savings())

        # Case: Goal
        # expected: 700,000
        self.assertEqual(self.control_goal,
                         self.retirement_calculator.get_goal())
