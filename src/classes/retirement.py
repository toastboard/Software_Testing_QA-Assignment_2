...
class RetirementCalculator:
    ...
    percent_savings: stands for savings per year; percentage representing the portion of salary allocated to savings each year
    goal: the goal of the person the calculator will calculate for

    Methods
    -------
    calculate_savings_age: calculates the age at which the person will achieve their savings goal given the values in the attributes
    is_goal_reachable: tells if goal is reachable (goal can be reached before person turns 100)
    """
    ...
    def calculate_savings_age(self):
        """Returns the number of years until the person's saving goals will be met.
