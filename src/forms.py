...
class RetirementCalculatorForm(FlaskForm):
    ...
    salary = IntegerField('Salary', validators=[InputRequired(),
                                                NumberRange(min=1,
                                                            max=500000)])
    percent_savings = IntegerField('Percent Savings',
                                   validators=[InputRequired()])
    ...
    savings_goal = IntegerField('Savings Goal', validators=[InputRequired(),
                                                            NumberRange(min=1,
                                                                        max=2000000)
                                                            ])
...
class BMICalculatorForm(FlaskForm):
    weight = DecimalField('Weight in pounds', validators=[InputRequired(),
                                                          NumberRange(min=1,
                                                                      max=900)
                                                          ])
    height = DecimalField('Height in inches', validators=[InputRequired(),
                                                          NumberRange(min=1,
                                                                      max=108)
                                                          ])
    submit = SubmitField('Submit')
